...
#ifndef _TAO_IDL_RTECSCHEDULERS_SE2PWO_CPP_
#define _TAO_IDL_RTECSCHEDULERS_SE2PWO_CPP_
  ...
  TAO_ServantBase *servant)
{
  ...
  POA_RtecScheduler::Scheduler * const impl =
    dynamic_cast<POA_RtecScheduler::Scheduler *> (servant);
...
void POA_RtecScheduler::Scheduler::_dispatch (
