...
#ifndef _TAO_IDL_FTRTECEVENTCOMMC_JA882F_H_
#define _TAO_IDL_FTRTECEVENTCOMMC_JA882F_H_
...
#define _FTRTECEVENTCOMM_OBJECTID_CH_
  ...
  class ObjectId;
  typedef ::TAO_FixedSeq_Var_T<ObjectId> ObjectId_var;
  typedef ::TAO_Seq_Out_T<ObjectId> ObjectId_out;
  ...
  public:
    ...
    ObjectId (::CORBA::ULong length, const ACE_Message_Block* mb)
...
#define _FTRTECEVENTCOMM_AMI_PUSHCONSUMERHANDLER__VAR_OUT_CH_
  ...
  class AMI_PushConsumerHandler;
  typedef AMI_PushConsumerHandler *AMI_PushConsumerHandler_ptr;
  typedef TAO_Objref_Var_T<AMI_PushConsumerHandler> AMI_PushConsumerHandler_var;
