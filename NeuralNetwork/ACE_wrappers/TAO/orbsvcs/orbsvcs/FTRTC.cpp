...
namespace TAO
{
  template<>
  ::CORBA::Boolean
  Any_Dual_Impl_T<FTRT::OutOfSequence>::demarshal_value (TAO_InputCDR & cdr)
  {
    ::CORBA::String_var id;
...
namespace TAO
{
  template<>
  ::CORBA::Boolean
  Any_Dual_Impl_T<FTRT::TransactionDepthTooHigh>::demarshal_value (TAO_InputCDR & cdr)
  {
    ::CORBA::String_var id;
...
namespace TAO
{
  template<>
  ::CORBA::Boolean
  Any_Dual_Impl_T<FTRT::InvalidUpdate>::demarshal_value (TAO_InputCDR & cdr)
  {
    ::CORBA::String_var id;
