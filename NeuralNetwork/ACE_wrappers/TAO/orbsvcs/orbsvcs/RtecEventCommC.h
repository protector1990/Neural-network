...
#ifndef _TAO_IDL_RTECEVENTCOMMC_I4DZKN_H_
#define _TAO_IDL_RTECEVENTCOMMC_I4DZKN_H_
...
#define _RTECEVENTCOMM_EVENTSET_CH_
  ...
  class EventSet;
  typedef ::TAO_VarSeq_Var_T<EventSet> EventSet_var;
  typedef ::TAO_Seq_Out_T<EventSet> EventSet_out;
  

  class TAO_RTEvent_Export EventSet
    : public
        ::TAO::unbounded_value_sequence< Event>
  {
  public:
    EventSet (void);
