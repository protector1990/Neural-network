...
#ifndef _TAO_IDL_NOTIFYEXTS_6QBC2X_CPP_
#define _TAO_IDL_NOTIFYEXTS_6QBC2X_CPP_
  ...
  TAO_ServantBase *servant)
{
  ...
  POA_NotifyExt::ReconnectionCallback * const impl =
    dynamic_cast<POA_NotifyExt::ReconnectionCallback *> (servant);
...
void POA_NotifyExt::ReconnectionCallback::_dispatch (
  ...
  TAO_ServantBase *servant)
{
  ...
  POA_NotifyExt::ReconnectionRegistry * const impl =
    dynamic_cast<POA_NotifyExt::ReconnectionRegistry *> (servant);
...
void POA_NotifyExt::ReconnectionRegistry::_dispatch (
  TAO_ServerRequest & req,
  TAO::Portable_Server::Servant_Upcall* servant_upcall)
{
  this->synchronous_upcall_dispatch (req, servant_upcall, this);
  ...
  TAO_ServantBase *servant)
{
  ...
  POA_NotifyExt::EventChannelFactory * const impl =
    dynamic_cast<POA_NotifyExt::EventChannelFactory *> (servant);
...
void POA_NotifyExt::EventChannelFactory::_dispatch (
  TAO_ServerRequest & req,
  TAO::Portable_Server::Servant_Upcall* servant_upcall)
{
  this->synchronous_upcall_dispatch (req, servant_upcall, this);
  ...
  TAO_ServantBase *servant)
{
  ...
  POA_NotifyExt::ConsumerAdmin * const impl =
    dynamic_cast<POA_NotifyExt::ConsumerAdmin *> (servant);
...
void POA_NotifyExt::ConsumerAdmin::_dispatch (
  TAO_ServerRequest & req,
  TAO::Portable_Server::Servant_Upcall* servant_upcall)
{
  this->synchronous_upcall_dispatch (req, servant_upcall, this);
  ...
  TAO_ServantBase *servant)
{
  ...
  POA_NotifyExt::SupplierAdmin * const impl =
    dynamic_cast<POA_NotifyExt::SupplierAdmin *> (servant);
...
void POA_NotifyExt::SupplierAdmin::_dispatch (
  TAO_ServerRequest & req,
  TAO::Portable_Server::Servant_Upcall* servant_upcall)
{
  this->synchronous_upcall_dispatch (req, servant_upcall, this);
