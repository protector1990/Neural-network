...
#ifndef _TAO_IDL_COSEVENTCOMMC_CI0OWU_H_
#define _TAO_IDL_COSEVENTCOMMC_CI0OWU_H_
...
#define _COSEVENTCOMM_PULLCONSUMER__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<PullConsumer> PullConsumer_var;
  typedef TAO_Objref_Out_T<PullConsumer> PullConsumer_out;
...
#define _COSEVENTCOMM_PULLSUPPLIER__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<PullSupplier> PullSupplier_var;
  typedef TAO_Objref_Out_T<PullSupplier> PullSupplier_out;
