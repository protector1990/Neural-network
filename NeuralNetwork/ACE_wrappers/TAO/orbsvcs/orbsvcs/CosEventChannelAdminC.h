...
#ifndef _TAO_IDL_COSEVENTCHANNELADMINC_QPHHUM_H_
#define _TAO_IDL_COSEVENTCHANNELADMINC_QPHHUM_H_
...
#define _COSEVENTCHANNELADMIN_PROXYPULLSUPPLIER__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<ProxyPullSupplier> ProxyPullSupplier_var;
  typedef TAO_Objref_Out_T<ProxyPullSupplier> ProxyPullSupplier_out;
...
#define _COSEVENTCHANNELADMIN_PROXYPULLCONSUMER__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<ProxyPullConsumer> ProxyPullConsumer_var;
  typedef TAO_Objref_Out_T<ProxyPullConsumer> ProxyPullConsumer_out;
