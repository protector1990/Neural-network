...
#ifndef _TAO_IDL_COSTYPEDEVENTCHANNELADMINC_T617O7_H_
#define _TAO_IDL_COSTYPEDEVENTCHANNELADMINC_T617O7_H_
...
#define _COSTYPEDEVENTCHANNELADMIN_TYPEDPROXYPUSHCONSUMER__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<TypedProxyPushConsumer> TypedProxyPushConsumer_var;
  typedef TAO_Objref_Out_T<TypedProxyPushConsumer> TypedProxyPushConsumer_out;
...
#define _COSTYPEDEVENTCHANNELADMIN_TYPEDPROXYPULLSUPPLIER__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<TypedProxyPullSupplier> TypedProxyPullSupplier_var;
  typedef TAO_Objref_Out_T<TypedProxyPullSupplier> TypedProxyPullSupplier_out;
...
#define _COSTYPEDEVENTCHANNELADMIN_TYPEDSUPPLIERADMIN__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<TypedSupplierAdmin> TypedSupplierAdmin_var;
  typedef TAO_Objref_Out_T<TypedSupplierAdmin> TypedSupplierAdmin_out;
...
#define _COSTYPEDEVENTCHANNELADMIN_TYPEDCONSUMERADMIN__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<TypedConsumerAdmin> TypedConsumerAdmin_var;
  typedef TAO_Objref_Out_T<TypedConsumerAdmin> TypedConsumerAdmin_out;
...
#define _COSTYPEDEVENTCHANNELADMIN_TYPEDEVENTCHANNEL__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<TypedEventChannel> TypedEventChannel_var;
  typedef TAO_Objref_Out_T<TypedEventChannel> TypedEventChannel_out;
