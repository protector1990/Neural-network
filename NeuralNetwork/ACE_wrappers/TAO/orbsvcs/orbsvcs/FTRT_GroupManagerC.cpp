...
FTRT::ManagerInfoList::ManagerInfoList (
    ::CORBA::ULong max)
  : ::TAO::unbounded_value_sequence< ManagerInfo> (max)
{}
...
FTRT::ManagerInfoList::ManagerInfoList (
  ...
  : ::TAO::unbounded_value_sequence< ManagerInfo> (seq)
{}
...
namespace TAO
{
  template<>
  ::CORBA::Boolean
  Any_Dual_Impl_T<FTRT::PredecessorUnreachable>::demarshal_value (TAO_InputCDR & cdr)
  {
    ::CORBA::String_var id;
...
namespace TAO
{
  template<>
  ::CORBA::Boolean
  Any_Dual_Impl_T<FTRT::InvalidState>::demarshal_value (TAO_InputCDR & cdr)
  {
    ::CORBA::String_var id;
