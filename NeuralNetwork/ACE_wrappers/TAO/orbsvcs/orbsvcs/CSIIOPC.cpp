...
CSIIOP::ServiceConfigurationList::ServiceConfigurationList (
    ::CORBA::ULong max)
  : ::TAO::unbounded_value_sequence< ServiceConfiguration> (max)
{}
...
CSIIOP::ServiceConfigurationList::ServiceConfigurationList (
  ...
  : ::TAO::unbounded_value_sequence< ServiceConfiguration> (seq)
{}
...
CSIIOP::CompoundSecMechanisms::CompoundSecMechanisms (
    ::CORBA::ULong max)
  : ::TAO::unbounded_value_sequence< CompoundSecMech> (max)
{}
...
CSIIOP::CompoundSecMechanisms::CompoundSecMechanisms (
  ...
  : ::TAO::unbounded_value_sequence< CompoundSecMech> (seq)
{}
...
CSIIOP::TransportAddressList::TransportAddressList (
    ::CORBA::ULong max)
  : ::TAO::unbounded_value_sequence< TransportAddress> (max)
{}
...
CSIIOP::TransportAddressList::TransportAddressList (
  ...
  : ::TAO::unbounded_value_sequence< TransportAddress> (seq)
{}
