...
#ifndef _TAO_IDL_CSIIOPC_PGI62M_H_
#define _TAO_IDL_CSIIOPC_PGI62M_H_
...
#define _CSIIOP_SERVICESPECIFICNAME_CH_
  ...
  typedef ::TAO_FixedSeq_Var_T<ServiceSpecificName> ServiceSpecificName_var;
  typedef ::TAO_Seq_Out_T<ServiceSpecificName> ServiceSpecificName_out;
  ...
  public:
    ...
    ServiceSpecificName (::CORBA::ULong length, const ACE_Message_Block* mb)
...
#define _CSIIOP_SERVICECONFIGURATIONLIST_CH_
  ...
  typedef ::TAO_VarSeq_Var_T<ServiceConfigurationList> ServiceConfigurationList_var;
  typedef ::TAO_Seq_Out_T<ServiceConfigurationList> ServiceConfigurationList_out;
  

  class TAO_Security_Export ServiceConfigurationList
    : public
        ::TAO::unbounded_value_sequence< ServiceConfiguration>
  {
  public:
...
#define _CSIIOP_COMPOUNDSECMECHANISMS_CH_
  ...
  typedef ::TAO_VarSeq_Var_T<CompoundSecMechanisms> CompoundSecMechanisms_var;
  typedef ::TAO_Seq_Out_T<CompoundSecMechanisms> CompoundSecMechanisms_out;
  

  class TAO_Security_Export CompoundSecMechanisms
    : public
        ::TAO::unbounded_value_sequence< CompoundSecMech>
  {
  public:
...
#define _CSIIOP_TRANSPORTADDRESSLIST_CH_
  ...
  typedef ::TAO_VarSeq_Var_T<TransportAddressList> TransportAddressList_var;
  typedef ::TAO_Seq_Out_T<TransportAddressList> TransportAddressList_out;
  

  class TAO_Security_Export TransportAddressList
    : public
        ::TAO::unbounded_value_sequence< TransportAddress>
  {
  public:
