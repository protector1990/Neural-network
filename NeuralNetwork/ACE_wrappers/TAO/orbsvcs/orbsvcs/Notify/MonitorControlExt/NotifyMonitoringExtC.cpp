...
namespace TAO
{
  template<>
  ::CORBA::Boolean
  Any_Dual_Impl_T<NotifyMonitoringExt::NameAlreadyUsed>::demarshal_value (TAO_InputCDR & cdr)
  {
    ::CORBA::String_var id;
...
namespace TAO
{
  template<>
  ::CORBA::Boolean
  Any_Dual_Impl_T<NotifyMonitoringExt::NameMapError>::demarshal_value (TAO_InputCDR & cdr)
  {
    ::CORBA::String_var id;
