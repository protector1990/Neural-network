...
#ifndef _TAO_IDL_FT_CORBA_ORBC_NPM8UK_H_
#define _TAO_IDL_FT_CORBA_ORBC_NPM8UK_H_
...
#define _FT_REQUESTDURATIONPOLICY__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<RequestDurationPolicy> RequestDurationPolicy_var;
  typedef TAO_Objref_Out_T<RequestDurationPolicy> RequestDurationPolicy_out;
...
#define _FT_HEARTBEATPOLICY__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<HeartbeatPolicy> HeartbeatPolicy_var;
  typedef TAO_Objref_Out_T<HeartbeatPolicy> HeartbeatPolicy_out;
...
#define _FT_HEARTBEATENABLEDPOLICY__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<HeartbeatEnabledPolicy> HeartbeatEnabledPolicy_var;
  typedef TAO_Objref_Out_T<HeartbeatEnabledPolicy> HeartbeatEnabledPolicy_out;
