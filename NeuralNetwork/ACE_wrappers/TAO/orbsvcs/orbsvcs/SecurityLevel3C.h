...
#ifndef _TAO_IDL_SECURITYLEVEL3C_OVJKPB_H_
#define _TAO_IDL_SECURITYLEVEL3C_OVJKPB_H_
...
#define _SECURITYLEVEL3_NAMEPATH_CH_
  ...
  class NamePath;
  typedef ::TAO_VarSeq_Var_T<NamePath> NamePath_var;
  typedef ::TAO_Seq_Out_T<NamePath> NamePath_out;
...
#define _SECURITYLEVEL3_PRINCIPALNAMELIST_CH_
  ...
  typedef ::TAO_VarSeq_Var_T<PrincipalNameList> PrincipalNameList_var;
  typedef ::TAO_Seq_Out_T<PrincipalNameList> PrincipalNameList_out;
  

  class TAO_Security_Export PrincipalNameList
    : public
        ::TAO::unbounded_value_sequence< PrincipalName>
  {
  public:
...
#define _SECURITYLEVEL3_PRINATTRIBUTELIST_CH_
  ...
  typedef ::TAO_VarSeq_Var_T<PrinAttributeList> PrinAttributeList_var;
  typedef ::TAO_Seq_Out_T<PrinAttributeList> PrinAttributeList_out;
  

  class TAO_Security_Export PrinAttributeList
    : public
        ::TAO::unbounded_value_sequence< PrinAttribute>
  {
  public:
...
#define _SECURITYLEVEL3_RESOURCENAMECOMPONENTS_CH_
  ...
  typedef ::TAO_VarSeq_Var_T<ResourceNameComponents> ResourceNameComponents_var;
  typedef ::TAO_Seq_Out_T<ResourceNameComponents> ResourceNameComponents_out;
...
#define _SECURITYLEVEL3_RESOURCENAMELIST_CH_
  ...
  typedef ::TAO_VarSeq_Var_T<ResourceNameList> ResourceNameList_var;
  typedef ::TAO_Seq_Out_T<ResourceNameList> ResourceNameList_out;
  

  class TAO_Security_Export ResourceNameList
    : public
        ::TAO::unbounded_value_sequence< ResourceName>
  {
  public:
...
#define _SECURITYLEVEL3_SCOPEDPRIVILEGESLIST_CH_
  ...
  typedef ::TAO_VarSeq_Var_T<ScopedPrivilegesList> ScopedPrivilegesList_var;
  typedef ::TAO_Seq_Out_T<ScopedPrivilegesList> ScopedPrivilegesList_out;
  

  class TAO_Security_Export ScopedPrivilegesList
    : public
        ::TAO::unbounded_value_sequence< ScopedPrivileges>
  {
  public:
...
#define _SECURITYLEVEL3_PRINCIPAL__VAR_OUT_CH_
  ...
  public:
    ...
    // TAO_IDL - Generated from
    // c:\private\datascience\neuralna_mreza\neuralnetwork\ace_wrappers\tao\tao_idl\be\be_visitor_valuetype\field_ch.cpp:459
  ...
  public:
    ...
    // TAO_IDL - Generated from
    // c:\private\datascience\neuralna_mreza\neuralnetwork\ace_wrappers\tao\tao_idl\be\be_visitor_valuetype\field_ch.cpp:674
  ...
  public:
    ...
    // TAO_IDL - Generated from
    // c:\private\datascience\neuralna_mreza\neuralnetwork\ace_wrappers\tao\tao_idl\be\be_visitor_valuetype\field_ch.cpp:533
  ...
  // TAO_IDL - Generated from
  // c:\private\datascience\neuralna_mreza\neuralnetwork\ace_wrappers\tao\tao_idl\be\be_visitor_valuetype\valuetype_init_ch.cpp:57
...
#define _SECURITYLEVEL3_PRINCIPALLIST_CH_
  ...
  class PrincipalList;
  typedef ::TAO_VarSeq_Var_T<PrincipalList> PrincipalList_var;
  typedef ::TAO_Seq_Out_T<PrincipalList> PrincipalList_out;
...
#define _SECURITYLEVEL3_PROXYPRINCIPAL__VAR_OUT_CH_
  ...
  public:
    ...
    // TAO_IDL - Generated from
    // c:\private\datascience\neuralna_mreza\neuralnetwork\ace_wrappers\tao\tao_idl\be\be_visitor_valuetype\field_ch.cpp:361
...
#define _SECURITYLEVEL3_ENCODING_CH_
  ...
  class Encoding;
  typedef ::TAO_FixedSeq_Var_T<Encoding> Encoding_var;
  typedef ::TAO_Seq_Out_T<Encoding> Encoding_out;
  ...
  public:
    ...
    Encoding (::CORBA::ULong length, const ACE_Message_Block* mb)
...
#define _SECURITYLEVEL3_STATEMENT__VAR_OUT_CH_
  ...
  protected:
    ...
    // TAO_IDL - Generated from
    // c:\private\datascience\neuralna_mreza\neuralnetwork\ace_wrappers\tao\tao_idl\be\be_visitor_valuetype\field_ch.cpp:608
...
class StatementList;
typedef ::TAO_VarSeq_Var_T<StatementList> StatementList_var;
typedef ::TAO_Seq_Out_T<StatementList> StatementList_out;
...
typedef ::TAO_VarSeq_Var_T<X509IdentityStatementList> X509IdentityStatementList_var;
typedef ::TAO_Seq_Out_T<X509IdentityStatementList> X509IdentityStatementList_out;
...
typedef ::TAO_VarSeq_Var_T<CredentialsIdList> CredentialsIdList_var;
typedef ::TAO_Seq_Out_T<CredentialsIdList> CredentialsIdList_out;
...
typedef TAO_Objref_Var_T<CredsInitiator> CredsInitiator_var;
typedef TAO_Objref_Out_T<CredsInitiator> CredsInitiator_out;
...
typedef TAO_Objref_Var_T<CredsAcceptor> CredsAcceptor_var;
typedef TAO_Objref_Out_T<CredsAcceptor> CredsAcceptor_out;
...
typedef TAO_Objref_Var_T<RelinquishedCredentialsListener> RelinquishedCredentialsListener_var;
typedef TAO_Objref_Out_T<RelinquishedCredentialsListener> RelinquishedCredentialsListener_out;
...
typedef TAO_Objref_Var_T<Credentials> Credentials_var;
typedef TAO_Objref_Out_T<Credentials> Credentials_out;
...
typedef ::TAO_VarSeq_Var_T<CredentialsList> CredentialsList_var;
typedef ::TAO_Seq_Out_T<CredentialsList> CredentialsList_out;
...
typedef TAO_Objref_Var_T<OwnCredentials> OwnCredentials_var;
typedef TAO_Objref_Out_T<OwnCredentials> OwnCredentials_out;
...
typedef ::TAO_VarSeq_Var_T<OwnCredentialsList> OwnCredentialsList_var;
typedef ::TAO_Seq_Out_T<OwnCredentialsList> OwnCredentialsList_out;
...
typedef TAO_Objref_Var_T<ClientCredentials> ClientCredentials_var;
typedef TAO_Objref_Out_T<ClientCredentials> ClientCredentials_out;
...
typedef TAO_Objref_Var_T<TargetCredentials> TargetCredentials_var;
typedef TAO_Objref_Out_T<TargetCredentials> TargetCredentials_out;
...
typedef TAO_Objref_Var_T<ContextEstablishmentPolicy> ContextEstablishmentPolicy_var;
typedef TAO_Objref_Out_T<ContextEstablishmentPolicy> ContextEstablishmentPolicy_out;
...
typedef TAO_Objref_Var_T<ObjectCredentialsPolicy> ObjectCredentialsPolicy_var;
typedef TAO_Objref_Out_T<ObjectCredentialsPolicy> ObjectCredentialsPolicy_out;
...
typedef ::TAO_VarSeq_Var_T<AcquisitionMethodList> AcquisitionMethodList_var;
typedef ::TAO_Seq_Out_T<AcquisitionMethodList> AcquisitionMethodList_out;
...
typedef TAO_Objref_Var_T<CredentialsAcquirer> CredentialsAcquirer_var;
typedef TAO_Objref_Out_T<CredentialsAcquirer> CredentialsAcquirer_out;
...
typedef TAO_Objref_Var_T<CredentialsCurator> CredentialsCurator_var;
typedef TAO_Objref_Out_T<CredentialsCurator> CredentialsCurator_out;
...
typedef TAO_Objref_Var_T<SecurityManager> SecurityManager_var;
typedef TAO_Objref_Out_T<SecurityManager> SecurityManager_out;
...
typedef TAO_Objref_Var_T<SecurityCurrent> SecurityCurrent_var;
typedef TAO_Objref_Out_T<SecurityCurrent> SecurityCurrent_out;
