...
#ifndef _TAO_IDL_NULL_MEDIACTRLC_BUE0SD_H_
#define _TAO_IDL_NULL_MEDIACTRLC_BUE0SD_H_
...
typedef TAO_Objref_Var_T<Null_MediaCtrl> Null_MediaCtrl_var;
typedef TAO_Objref_Out_T<Null_MediaCtrl> Null_MediaCtrl_out;
