...
#ifndef _TAO_IDL_SECURITYLEVEL2C_HLKDLE_H_
#define _TAO_IDL_SECURITYLEVEL2C_HLKDLE_H_
...
#define _SECURITYLEVEL2_PRINCIPALAUTHENTICATOR__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<PrincipalAuthenticator> PrincipalAuthenticator_var;
  typedef TAO_Objref_Out_T<PrincipalAuthenticator> PrincipalAuthenticator_out;
...
#define _SECURITYLEVEL2_RECEIVEDCREDENTIALS__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<ReceivedCredentials> ReceivedCredentials_var;
  typedef TAO_Objref_Out_T<ReceivedCredentials> ReceivedCredentials_out;
...
#define _SECURITYLEVEL2_REQUIREDRIGHTS__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<RequiredRights> RequiredRights_var;
  typedef TAO_Objref_Out_T<RequiredRights> RequiredRights_out;
...
#define _SECURITYLEVEL2_AUDITCHANNEL__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<AuditChannel> AuditChannel_var;
  typedef TAO_Objref_Out_T<AuditChannel> AuditChannel_out;
...
#define _SECURITYLEVEL2_AUDITDECISION__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<AuditDecision> AuditDecision_var;
  typedef TAO_Objref_Out_T<AuditDecision> AuditDecision_out;
...
#define _SECURITYLEVEL2_ACCESSDECISION__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<AccessDecision> AccessDecision_var;
  typedef TAO_Objref_Out_T<AccessDecision> AccessDecision_out;
...
#define _SECURITYLEVEL2_QOPPOLICY__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<QOPPolicy> QOPPolicy_var;
  typedef TAO_Objref_Out_T<QOPPolicy> QOPPolicy_out;
...
#define _SECURITYLEVEL2_MECHANISMPOLICY__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<MechanismPolicy> MechanismPolicy_var;
  typedef TAO_Objref_Out_T<MechanismPolicy> MechanismPolicy_out;
...
#define _SECURITYLEVEL2_INVOCATIONCREDENTIALSPOLICY__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<InvocationCredentialsPolicy> InvocationCredentialsPolicy_var;
  typedef TAO_Objref_Out_T<InvocationCredentialsPolicy> InvocationCredentialsPolicy_out;
...
#define _SECURITYLEVEL2_ESTABLISHTRUSTPOLICY__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<EstablishTrustPolicy> EstablishTrustPolicy_var;
  typedef TAO_Objref_Out_T<EstablishTrustPolicy> EstablishTrustPolicy_out;
...
#define _SECURITYLEVEL2_DELEGATIONDIRECTIVEPOLICY__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<DelegationDirectivePolicy> DelegationDirectivePolicy_var;
  typedef TAO_Objref_Out_T<DelegationDirectivePolicy> DelegationDirectivePolicy_out;
...
#define _TAO_SL2_ACCESSDECISION__VAR_OUT_CH_
    ...
    public:
      ...
      virtual ::CORBA::Boolean access_allowed_ex (
        ...
        const ::SecurityLevel2::CredentialsList & cred_list,
        const char * operation_name,
        ::CORBA::Boolean collocation_invocation) = 0;
      ...
      virtual void default_collocated_decision (
        ::CORBA::Boolean default_collocated_decision) = 0;
