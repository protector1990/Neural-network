...
#ifndef _TAO_IDL_FT_REPLICATIONMANAGERS_XEVBK1_CPP_
#define _TAO_IDL_FT_REPLICATIONMANAGERS_XEVBK1_CPP_
  ...
  TAO_ServantBase *servant)
{
  ...
  POA_FT::ReplicationManager * const impl =
    dynamic_cast<POA_FT::ReplicationManager *> (servant);
...
void POA_FT::ReplicationManager::_dispatch (
