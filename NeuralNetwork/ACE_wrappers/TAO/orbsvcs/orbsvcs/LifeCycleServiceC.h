...
#ifndef _TAO_IDL_LIFECYCLESERVICEC_ASF2ZP_H_
#define _TAO_IDL_LIFECYCLESERVICEC_ASF2ZP_H_
...
#define _LIFECYCLESERVICE_LIFE_CYCLE_SERVICE__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<Life_Cycle_Service> Life_Cycle_Service_var;
  typedef TAO_Objref_Out_T<Life_Cycle_Service> Life_Cycle_Service_out;
...
#define _LIFECYCLESERVICE_CRITERIA_EVALUATOR__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<Criteria_Evaluator> Criteria_Evaluator_var;
  typedef TAO_Objref_Out_T<Criteria_Evaluator> Criteria_Evaluator_out;
