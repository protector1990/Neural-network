...
namespace TAO
{
  template<>
  ::CORBA::Boolean
  Any_Dual_Impl_T<FT::NoStateAvailable>::demarshal_value (TAO_InputCDR & cdr)
  {
    ::CORBA::String_var id;
...
namespace TAO
{
  template<>
  ::CORBA::Boolean
  Any_Dual_Impl_T<FT::InvalidState>::demarshal_value (TAO_InputCDR & cdr)
  {
    ::CORBA::String_var id;
...
namespace TAO
{
  template<>
  ::CORBA::Boolean
  Any_Dual_Impl_T<FT::NoUpdateAvailable>::demarshal_value (TAO_InputCDR & cdr)
  {
    ::CORBA::String_var id;
...
namespace TAO
{
  template<>
  ::CORBA::Boolean
  Any_Dual_Impl_T<FT::InvalidUpdate>::demarshal_value (TAO_InputCDR & cdr)
  {
    ::CORBA::String_var id;
