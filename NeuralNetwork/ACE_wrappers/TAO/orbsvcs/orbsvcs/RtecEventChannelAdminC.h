...
#ifndef _TAO_IDL_RTECEVENTCHANNELADMINC_1U4UCL_H_
#define _TAO_IDL_RTECEVENTCHANNELADMINC_1U4UCL_H_
...
#define _RTECEVENTCHANNELADMIN_DEPENDENCYSET_CH_
  ...
  class DependencySet;
  typedef ::TAO_VarSeq_Var_T<DependencySet> DependencySet_var;
  typedef ::TAO_Seq_Out_T<DependencySet> DependencySet_out;
...
#define _RTECEVENTCHANNELADMIN_PUBLICATIONSET_CH_
  ...
  typedef ::TAO_VarSeq_Var_T<PublicationSet> PublicationSet_var;
  typedef ::TAO_Seq_Out_T<PublicationSet> PublicationSet_out;
