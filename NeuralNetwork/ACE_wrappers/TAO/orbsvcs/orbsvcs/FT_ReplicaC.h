...
#ifndef _TAO_IDL_FT_REPLICAC_IKAGWU_H_
#define _TAO_IDL_FT_REPLICAC_IKAGWU_H_
...
#define _FT_PULLMONITORABLE__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<PullMonitorable> PullMonitorable_var;
  typedef TAO_Objref_Out_T<PullMonitorable> PullMonitorable_out;
...
#define _FT_CHECKPOINTABLE__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<Checkpointable> Checkpointable_var;
  typedef TAO_Objref_Out_T<Checkpointable> Checkpointable_out;
