...
#ifndef _TAO_IDL_MIOPC_X10JOG_H_
#define _TAO_IDL_MIOPC_X10JOG_H_
...
#define _MIOP_UNIQUEID_CH_
  ...
  class UniqueId;
  typedef ::TAO_FixedSeq_Var_T<UniqueId> UniqueId_var;
  typedef ::TAO_Seq_Out_T<UniqueId> UniqueId_out;
  ...
  extern TAO_PortableGroup_Export char4_slice *
  char4_alloc (void);

  extern TAO_PortableGroup_Export void
  char4_free (
...
#define _MIOP_COMPONENT_SEQ_CH_
  ...
  class Component_Seq;
  typedef ::TAO_VarSeq_Var_T<Component_Seq> Component_Seq_var;
  typedef ::TAO_Seq_Out_T<Component_Seq> Component_Seq_out;
