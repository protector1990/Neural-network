...
#ifndef _TAO_IDL_NOTIFYEXTC_VDI9PU_H_
#define _TAO_IDL_NOTIFYEXTC_VDI9PU_H_
...
#define _NOTIFYEXT_THREADPOOLLANES_LIST_CH_
  ...
  typedef ::TAO_FixedSeq_Var_T<ThreadPoolLanes_List> ThreadPoolLanes_List_var;
  typedef ::TAO_Seq_Out_T<ThreadPoolLanes_List> ThreadPoolLanes_List_out;
...
#define _NOTIFYEXT_RECONNECTIONCALLBACK__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<ReconnectionCallback> ReconnectionCallback_var;
  typedef TAO_Objref_Out_T<ReconnectionCallback> ReconnectionCallback_out;
...
#define _NOTIFYEXT_RECONNECTIONREGISTRY__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<ReconnectionRegistry> ReconnectionRegistry_var;
  typedef TAO_Objref_Out_T<ReconnectionRegistry> ReconnectionRegistry_out;
