...
#ifndef _TAO_IDL_COSLOADBALANCINGC_GITCXB_H_
#define _TAO_IDL_COSLOADBALANCINGC_GITCXB_H_
...
#define _COSLOADBALANCING_LOADLIST_CH_
  ...
  class LoadList;
  typedef ::TAO_FixedSeq_Var_T<LoadList> LoadList_var;
  typedef ::TAO_Seq_Out_T<LoadList> LoadList_out;
  

  class TAO_LoadBalancing_Export LoadList
    : public
        ::TAO::unbounded_value_sequence< Load>
  {
  public:
    LoadList (void);
...
#define _COSLOADBALANCING_LOADMANAGER__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<LoadManager> LoadManager_var;
  typedef TAO_Objref_Out_T<LoadManager> LoadManager_out;
...
#define _COSLOADBALANCING_AMI_STRATEGYHANDLER__VAR_OUT_CH_
  ...
  class AMI_StrategyHandler;
  typedef AMI_StrategyHandler *AMI_StrategyHandler_ptr;
  typedef TAO_Objref_Var_T<AMI_StrategyHandler> AMI_StrategyHandler_var;
  typedef TAO_Objref_Out_T<AMI_StrategyHandler> AMI_StrategyHandler_out;
  ...
  // TAO_IDL - Generated from
  // c:\private\datascience\neuralna_mreza\neuralnetwork\ace_wrappers\tao\tao_idl\be\be_visitor_typedef\typedef_ch.cpp:321
...
#define _COSLOADBALANCING_LOADALERT__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<LoadAlert> LoadAlert_var;
  typedef TAO_Objref_Out_T<LoadAlert> LoadAlert_out;
...
#define _COSLOADBALANCING_AMI_LOADALERTHANDLER__VAR_OUT_CH_
  ...
  class AMI_LoadAlertHandler;
  typedef AMI_LoadAlertHandler *AMI_LoadAlertHandler_ptr;
  typedef TAO_Objref_Var_T<AMI_LoadAlertHandler> AMI_LoadAlertHandler_var;
  typedef TAO_Objref_Out_T<AMI_LoadAlertHandler> AMI_LoadAlertHandler_out;
...
#define _COSLOADBALANCING_LOADMONITOR__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<LoadMonitor> LoadMonitor_var;
  typedef TAO_Objref_Out_T<LoadMonitor> LoadMonitor_out;
...
#define _COSLOADBALANCING_AMI_LOADMONITORHANDLER__VAR_OUT_CH_
  ...
  class AMI_LoadMonitorHandler;
  typedef AMI_LoadMonitorHandler *AMI_LoadMonitorHandler_ptr;
  typedef TAO_Objref_Var_T<AMI_LoadMonitorHandler> AMI_LoadMonitorHandler_var;
  typedef TAO_Objref_Out_T<AMI_LoadMonitorHandler> AMI_LoadMonitorHandler_out;
...
#define _COSLOADBALANCING_AMI_LOADMANAGERHANDLER__VAR_OUT_CH_
  ...
  class AMI_LoadManagerHandler;
  typedef AMI_LoadManagerHandler *AMI_LoadManagerHandler_ptr;
  typedef TAO_Objref_Var_T<AMI_LoadManagerHandler> AMI_LoadManagerHandler_var;
  typedef TAO_Objref_Out_T<AMI_LoadManagerHandler> AMI_LoadManagerHandler_out;
