...
#ifndef _TAO_IDL_FTRT_GROUPMANAGERC_MZMIGG_H_
#define _TAO_IDL_FTRT_GROUPMANAGERC_MZMIGG_H_
...
#define _FTRT_FAULTLISTENER__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<FaultListener> FaultListener_var;
  typedef TAO_Objref_Out_T<FaultListener> FaultListener_out;
...
#define _FTRT_AMI_FAULTLISTENERHANDLER__VAR_OUT_CH_
  ...
  class AMI_FaultListenerHandler;
  typedef AMI_FaultListenerHandler *AMI_FaultListenerHandler_ptr;
  typedef TAO_Objref_Var_T<AMI_FaultListenerHandler> AMI_FaultListenerHandler_var;
  typedef TAO_Objref_Out_T<AMI_FaultListenerHandler> AMI_FaultListenerHandler_out;
...
#define _FTRT_MANAGERINFOLIST_CH_
  ...
  typedef ::TAO_VarSeq_Var_T<ManagerInfoList> ManagerInfoList_var;
  typedef ::TAO_Seq_Out_T<ManagerInfoList> ManagerInfoList_out;
  

  class TAO_FtRtEvent_Export ManagerInfoList
    : public
        ::TAO::unbounded_value_sequence< ManagerInfo>
  {
  public:
