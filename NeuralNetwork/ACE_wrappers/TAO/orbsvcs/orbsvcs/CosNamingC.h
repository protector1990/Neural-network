...
#ifndef _TAO_IDL_COSNAMINGC_6SA0XM_H_
#define _TAO_IDL_COSNAMINGC_6SA0XM_H_
...
#define _COSNAMING_NAME_CH_
  ...
  class Name;
  typedef ::TAO_VarSeq_Var_T<Name> Name_var;
  typedef ::TAO_Seq_Out_T<Name> Name_out;
...
#define _COSNAMING_BINDINGLIST_CH_
  ...
  class BindingList;
  typedef ::TAO_VarSeq_Var_T<BindingList> BindingList_var;
  typedef ::TAO_Seq_Out_T<BindingList> BindingList_out;
...
#define _COSNAMING_BINDINGITERATOR__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<BindingIterator> BindingIterator_var;
  typedef TAO_Objref_Out_T<BindingIterator> BindingIterator_out;
...
#define _COSNAMING_NAMINGCONTEXT__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<NamingContext> NamingContext_var;
  typedef TAO_Objref_Out_T<NamingContext> NamingContext_out;
...
#define _COSNAMING_NAMINGCONTEXTEXT__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<NamingContextExt> NamingContextExt_var;
  typedef TAO_Objref_Out_T<NamingContextExt> NamingContextExt_out;
