...
#ifndef _TAO_IDL_FT_CORBAS_6RV9B9_CPP_
#define _TAO_IDL_FT_CORBAS_6RV9B9_CPP_
  ...
  TAO_ServantBase *servant)
{
  ...
  POA_FT::FTObjectGroupManager * const impl =
    dynamic_cast<POA_FT::FTObjectGroupManager *> (servant);
...
void POA_FT::FTObjectGroupManager::_dispatch (
