...
#ifndef _TAO_IDL_COSLIFECYCLEC_VRBBSG_H_
#define _TAO_IDL_COSLIFECYCLEC_VRBBSG_H_
...
#define _COSLIFECYCLE_FACTORIES_CH_
  ...
  class Factories;
  typedef ::TAO_VarSeq_Var_T<Factories> Factories_var;
  typedef ::TAO_Seq_Out_T<Factories> Factories_out;
...
#define _COSLIFECYCLE_CRITERIA_CH_
  ...
  class Criteria;
  typedef ::TAO_VarSeq_Var_T<Criteria> Criteria_var;
  typedef ::TAO_Seq_Out_T<Criteria> Criteria_out;
...
#define _COSLIFECYCLE_FACTORYFINDER__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<FactoryFinder> FactoryFinder_var;
  typedef TAO_Objref_Out_T<FactoryFinder> FactoryFinder_out;
...
#define _COSLIFECYCLE_LIFECYCLEOBJECT__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<LifeCycleObject> LifeCycleObject_var;
  typedef TAO_Objref_Out_T<LifeCycleObject> LifeCycleObject_out;
