...
// TAO_IDL - Generated from
// c:\private\datascience\neuralna_mreza\neuralnetwork\ace_wrappers\tao\tao_idl\be\be_visitor_union\discriminant_ci.cpp:145
...
ACE_INLINE
void
FtRtecEventChannelAdmin::ProxyPushConsumerConnectionParamter::_d ( ::CORBA::Short discval)
{
  this->disc_ = discval;
}
...
ACE_INLINE
void
FtRtecEventChannelAdmin::ProxyPushSupplierConnectionParamter::_d ( ::CORBA::Short discval)
{
  this->disc_ = discval;
}
