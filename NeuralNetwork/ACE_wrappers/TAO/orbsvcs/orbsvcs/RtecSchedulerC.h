...
#ifndef _TAO_IDL_RTECSCHEDULERC_BCNLSV_H_
#define _TAO_IDL_RTECSCHEDULERC_BCNLSV_H_
...
#define _RTECSCHEDULER_PERIOD_SET_CH_
  ...
  class Period_Set;
  typedef ::TAO_FixedSeq_Var_T<Period_Set> Period_Set_var;
  typedef ::TAO_Seq_Out_T<Period_Set> Period_Set_out;
  ...
  // TAO_IDL - Generated from
  // c:\private\datascience\neuralna_mreza\neuralnetwork\ace_wrappers\tao\tao_idl\be\be_visitor_typedef\typedef_ch.cpp:290
...
#define _RTECSCHEDULER_RT_INFO_ENABLE_STATE_PAIR_SET_CH_
  ...
  typedef ::TAO_FixedSeq_Var_T<RT_Info_Enable_State_Pair_Set> RT_Info_Enable_State_Pair_Set_var;
  typedef ::TAO_Seq_Out_T<RT_Info_Enable_State_Pair_Set> RT_Info_Enable_State_Pair_Set_out;
...
#define _RTECSCHEDULER_DEPENDENCY_SET_CH_
  ...
  typedef ::TAO_FixedSeq_Var_T<Dependency_Set> Dependency_Set_var;
  typedef ::TAO_Seq_Out_T<Dependency_Set> Dependency_Set_out;
...
#define _RTECSCHEDULER_CONFIG_INFO_SET_CH_
  ...
  typedef ::TAO_VarSeq_Var_T<Config_Info_Set> Config_Info_Set_var;
  typedef ::TAO_Seq_Out_T<Config_Info_Set> Config_Info_Set_out;
...
#define _RTECSCHEDULER_SCHEDULING_ANOMALY_SET_CH_
  ...
  typedef ::TAO_VarSeq_Var_T<Scheduling_Anomaly_Set> Scheduling_Anomaly_Set_var;
  typedef ::TAO_Seq_Out_T<Scheduling_Anomaly_Set> Scheduling_Anomaly_Set_out;
...
#define _RTECSCHEDULER_RT_INFO_SET_CH_
  ...
  class RT_Info_Set;
  typedef ::TAO_VarSeq_Var_T<RT_Info_Set> RT_Info_Set_var;
  typedef ::TAO_Seq_Out_T<RT_Info_Set> RT_Info_Set_out;
