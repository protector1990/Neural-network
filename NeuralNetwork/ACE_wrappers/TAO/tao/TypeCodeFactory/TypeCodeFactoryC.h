...
#ifndef _TAO_PIDL_TYPECODEFACTORYC_K9RJEQ_H_
#define _TAO_PIDL_TYPECODEFACTORYC_K9RJEQ_H_
...
#define _CORBA_TYPECODEFACTORY__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<TypeCodeFactory> TypeCodeFactory_var;
  typedef TAO_Objref_Out_T<TypeCodeFactory> TypeCodeFactory_out;
