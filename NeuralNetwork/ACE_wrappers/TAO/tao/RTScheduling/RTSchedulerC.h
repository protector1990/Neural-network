...
#ifndef _TAO_PIDL_RTSCHEDULERC_3A38AB_H_
#define _TAO_PIDL_RTSCHEDULERC_3A38AB_H_
...
#define _RTSCHEDULING_THREADACTION__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<ThreadAction> ThreadAction_var;
  typedef TAO_Objref_Out_T<ThreadAction> ThreadAction_out;
...
#define _RTSCHEDULING_DISTRIBUTABLETHREAD__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<DistributableThread> DistributableThread_var;
  typedef TAO_Objref_Out_T<DistributableThread> DistributableThread_out;
...
#define _RTSCHEDULING_RESOURCEMANAGER__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<ResourceManager> ResourceManager_var;
  typedef TAO_Objref_Out_T<ResourceManager> ResourceManager_out;
