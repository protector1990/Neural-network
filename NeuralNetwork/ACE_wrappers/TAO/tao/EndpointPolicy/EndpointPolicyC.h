...
#ifndef _TAO_PIDL_ENDPOINTPOLICYC_TB2VVK_H_
#define _TAO_PIDL_ENDPOINTPOLICYC_TB2VVK_H_
...
#define _ENDPOINTPOLICY_ENDPOINTVALUEBASE__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<EndpointValueBase> EndpointValueBase_var;
  typedef TAO_Objref_Out_T<EndpointValueBase> EndpointValueBase_out;
