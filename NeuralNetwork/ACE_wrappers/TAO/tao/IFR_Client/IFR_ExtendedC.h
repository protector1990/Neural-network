...
#ifndef _TAO_PIDL_IFR_EXTENDEDC_ATNPF4_H_
#define _TAO_PIDL_IFR_EXTENDEDC_ATNPF4_H_
...
#define _CORBA_VALUEMEMBERDEF__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<ValueMemberDef> ValueMemberDef_var;
  typedef TAO_Objref_Out_T<ValueMemberDef> ValueMemberDef_out;
