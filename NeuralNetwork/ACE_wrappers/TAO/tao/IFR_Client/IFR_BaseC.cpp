...
CORBA::StructMemberSeq::StructMemberSeq (
  ...
  : ::TAO::unbounded_value_sequence< StructMember> (seq)
{}
...
CORBA::InitializerSeq::InitializerSeq (
  ...
  : ::TAO::unbounded_value_sequence< Initializer> (seq)
{}
...
CORBA::ExcDescriptionSeq::ExcDescriptionSeq (
  ...
  : ::TAO::unbounded_value_sequence< ExceptionDescription> (seq)
{}
...
CORBA::ExtInitializerSeq::ExtInitializerSeq (
  ...
  : ::TAO::unbounded_value_sequence< ExtInitializer> (seq)
{}
...
CORBA::UnionMemberSeq::UnionMemberSeq (
  ...
  : ::TAO::unbounded_value_sequence< UnionMember> (seq)
{}
...
CORBA::Container::DescriptionSeq::DescriptionSeq (
  ...
  : ::TAO::unbounded_value_sequence< Description> (seq)
{}
